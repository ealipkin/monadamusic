...
(function () {
  function changeCover() {
    ...
    var songsContainer = document.querySelectorAll('.song-select');
    songsContainer.forEach(function (songContainer) {
      songContainer.classList.add('hide');
    });
    var visibleContainers = document.querySelectorAll('.song-select[data-id="' + activeIndex + '"]');
    visibleContainers.forEach(function (songContainer) {
  ...
  function updateLinks(index) {
    var songsLinks = songs[index].links;
    Object.keys(songsLinks).forEach(function (linkType) {
      var linkTag = document.querySelector('.buy-buttons a[data-id="' + linkType + '"]');
...
;(function ($) {
    ...
    $.widget('Project Name.songsSlider', {
        _create: function _create() {
            this._initCache();
            this._initEvents();
        },
